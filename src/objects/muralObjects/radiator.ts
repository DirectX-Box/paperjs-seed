...
export class Radiator extends MuralObject
{
    ...
    public static getNameGroundObject() : string { return "Radiateur";}

    // Renvoie la couleur du mur
    public getColor(): paper.Color { return new paper.Color("#CDDC39");}
}